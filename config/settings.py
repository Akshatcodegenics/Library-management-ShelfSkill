...
# Database configuration: fallback to SQLite if PostgreSQL env variables are absent
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'REST APIs for Digital Library App and Separate Admin Panel.',
    'VERSION': '2.0.0',
